...
public:
    virtual std::shared_ptr<AsyncContext> asyncRead(const KVCacheResourceV1&                     resource,
                                                    const std::shared_ptr<KVCacheConnectorMeta>& meta,
                                                    const KVCacheConnectorControlParams&         control_params) = 0;

    virtual std::shared_ptr<AsyncContext> asyncWrite(const KVCacheResourceV1&                     resource,
                                                     const std::shared_ptr<KVCacheConnectorMeta>& meta,
                                                     const KVCacheConnectorControlParams&         control_params) = 0;
