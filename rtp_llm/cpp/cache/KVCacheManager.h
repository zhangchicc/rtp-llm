...
public:
    ...
    std::shared_ptr<AsyncContext> asyncLoadCache(const KVCacheResourceV1&                     resource,
    ...
    std::shared_ptr<AsyncContext> asyncStoreCache(const KVCacheResourceV1&                     resource,
                                                  const std::shared_ptr<KVCacheConnectorMeta>& meta,
                                                  const KVCacheConnectorControlParams&         control_params);
